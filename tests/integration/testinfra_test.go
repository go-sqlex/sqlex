// testinfra_test.go — Common integration test infrastructure
//
// Supports SQLite + PostgreSQL + MySQL + SQL Server.
// Consistent with original sqlx_test.go RunWithSchema behavior: PostgreSQL → SQLite → MySQL → SQL Server.
