...
// If Valid is false, it returns JSON null.
func (n NullJSONText) MarshalJSON() ([]byte, error) {
	if !n.Valid {
		return []byte("null"), nil
	}
	return n.JSONText.MarshalJSON()
}

// UnmarshalJSON implements the json.Unmarshaler interface.
// If data is JSON null or empty, Valid is set to false.
func (n *NullJSONText) UnmarshalJSON(data []byte) error {
	...
	n.Valid = true
	return n.JSONText.UnmarshalJSON(data)
}
